...
if (round_num2 > 0)
    if (round_num2 == 1)
       ...
       prev_e = [buffer2(round_num2) 200 200]';
        
    elseif  (round_num2 == 2)
        prev_e = [buffer2(round_num2 - 1) buffer2(round_num2) 200]';
    elseif  (round_num2 == 3)
        prev_e = [buffer2(rc_CTIME - 2) buffer2(round_num2 - 1) buffer2(round_num2)]';
        %prev_e = ein2(rc_CTIME-pred_span+1:rc_CTIME);
    else
        prev_e = buffer2(round_num2-2:round_num2);
