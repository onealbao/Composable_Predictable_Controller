...
%   costMatrix = -nthroot(x1/(1000*1000*1000*1000*alpha*alpha),4) + nthroot(x2/(1000*1000),2) + x3/1500;
   costMatrix = -(x1-256*256*256*256*alpha*alpha*4)/(2000*2000*2000*2000*alpha*alpha) + (x2-256*256*4)/(2000*2000) - x3/1500;
